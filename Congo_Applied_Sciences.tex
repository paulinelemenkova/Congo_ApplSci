...
Satellite image processing is a fundamental problem in remote sensing data analysis. In this paper, we present an R programming language \cite{RCoreTeam} applied towards the unsupervised classification and NDVI calculation of Landsat-8 OLI/TIRS data on Congo. Motivated by recent reports regarding the environmental changes in rainfall tropical forests of central Africa \cite{Wasseige,lescuyer2010chainsaw,Jayathilake,POTAPOV2012106,Shapiro,7326202}, we applied multi-temporal data covering identical selected regions along the stream of upper Congo river, with a time span of 2013 to 2022, to demonstrate the dynamics of the landscapes over the years using Landsat satellite images. Our methods apply the k-means automated clustering and the calculation of the NDVI bands using R libraries RStoolbox, terra, raster and auxiliary graphical packages.

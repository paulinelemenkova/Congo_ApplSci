...
In this paper, we propose the use of R programming language as a means to process and classify Landsat images based on RSToolbox, raster and terra packages. The application of R for spatial analysis 

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Study Area}

The images used in this work were obtained for the region of Democratic Republic of Congo (DRC) with the three target areas located in the upper region of Congo River basin: the surrounding the towns Bumba, Basoko and Kisangani, lying on the Congo River, which serves as the main transportation artery for all these three cities (Figure \ref{fig01}). 
...
The importance of the Congo River region is explained by the crucial environmental role of the Congo River Basin in the global atmosphere circulation, producing the oxygen and  regulating Earth's global temperature through the absorption of solar radiation by rainforest massifs. Primary forests are essential ecosystems that play a key role in mitigating climate change \cite{SOMORIN2012288,BELE20151}. At the same time, shifting agriculture and land use practices including forest clearing become the major causes of hydrological flow regime \cite{4780136} and deforestation along with the increased population density and associated urban growth \cite{Wilkie1994}. Examples of conserving natural resources in the tropics include agroforests and the launched initiative on reducing emissions from deforestation and forest degradation (\href{https://www.fao.org/redd/overview/en/}{REDD+}) \cite{land11060918,Batsietal2021,SUFOKANKEU2020102081}. At the same time, Congo River basin is the most understudied regions in Africa and the global tropics \cite{Washingtonetal2006}. The approach we present here contributes to the environmental mapping of Congo River basin using remote sensing data and R programming methods.
...
\begin{lstlisting}[language=r, caption=R code using library terra used for calculation the NDVI; here a case of Basoko town (2013) with the same principle applied for all other images, label={lst:05}]
# Set up working directory
setwd("/Users/polinalemenkova/Documents/R/53_UC_k_means/Basoko_LC08_L1TP_177059_20131216_20200912_02_T1")
# Importing data

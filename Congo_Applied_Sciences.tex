...
\makebox[\textwidth][r]{\includegraphics[width=1.3\textwidth]{Basoko_grey_multibands.jpg}}%
	\caption{Composite map of the monochrome 11 bands of the Landsat-9 OLI/TIRS C1 for Basoko region (Arowumi tributary and Congo river): multi-spectral image 'LC09\_L1TP\_197055\_20220111\_20220122\_02\_T': Ultra Blue (B1), Blue (B2), Green (B3), Red (B4), Near Infrared (NIR) (B5), Shortwave Infrared (SWIR) 1 (B6), Shortwave Infrared (SWIR) 2 (B7), Panchromatic (B8), Cirrus (B9), Thermal Infrared (TIRS) 1 (B10), TIRS2 (B11). Plotting: R.}
	\label{fig04}
\end{figure} 
...
\caption{Natural and False colour composite visualization of Landsat 8 OLI image of Basoko region, Congo. Mapping: RStudio. Source: authors.}\label{fig07}
\end{figure}

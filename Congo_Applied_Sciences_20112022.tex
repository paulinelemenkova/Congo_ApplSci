...
The functionality of R programming presents a set of modular functions for the automation of image classification applications from Earth observation, spatial and remote sensing data, Figure \ref{fig:work}. 
...
The packages of 'terra' and 'raster' includes functionality of pre- and post-processing of both data types (vector and raster), and extensible features for spatial data analysis. Raster data analysis includes reading the information on spectral reflectance of the image bands automated processing of the stacked bands, feature extraction for unsupervised classification using clustering, creating multi-layer layers, performing map algebra using raster bands, visualising the thematic maps as overlays, classification and basic statistical analysis such as histograms.
